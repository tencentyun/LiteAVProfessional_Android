...
public class AudioEffectPanel extends FrameLayout {
    ...
    private static final String                 ONLINE_BGM_FIRST  =
            "http://dldir1.qq.com/hudongzhibo/LiteAV/demomusic/testmusic1.mp3";
    private static final String                 ONLINE_BGM_SECOND =
            "http://dldir1.qq.com/hudongzhibo/LiteAV/demomusic/testmusic2.mp3";
    private static final String                 ONLINE_BGM_THIRD  =
            "http://dldir1.qq.com/hudongzhibo/LiteAV/demomusic/testmusic3.mp3";
    ...
    public void closeAudioEffectPanel() {
        setVisibility(GONE);
        mMainAudioEffectPanel.setVisibility(GONE);
        mBGMPanel.setVisibility(GONE);
    ...
    private List<ItemEntity> createAudioChangeItems() {
        ...
        list.add(new ItemEntity(getResources().getString(R.string.audio_effect_setting_changetype_original),
                R.drawable.audio_effect_setting_changetype_original_open, AUDIO_VOICECHANGER_TYPE_0));
        list.add(new ItemEntity(getResources().getString(R.string.audio_effect_setting_changetype_child),
                R.drawable.audio_effect_setting_changetype_child, AUDIO_VOICECHANGER_TYPE_1));
        list.add(new ItemEntity(getResources().getString(R.string.audio_effect_setting_changetype_luoli),
                R.drawable.audio_effect_setting_changetype_luoli, AUDIO_VOICECHANGER_TYPE_2));
        list.add(new ItemEntity(getResources().getString(R.string.audio_effect_setting_changetype_dashu),
                R.drawable.audio_effect_setting_changetype_dashu, AUDIO_VOICECHANGER_TYPE_3));
        list.add(new ItemEntity(getResources().getString(R.string.audio_effect_setting_changetype_metal),
                R.drawable.audio_effect_setting_changetype_metal, AUDIO_VOICECHANGER_TYPE_4));
        //        list.add(new ItemEntity(getResources().getString(R.string.audio_effect_setting_changetype_sick), R
        //        .drawable.audio_effect_setting_changetype_sick, AUDIO_VOICECHANGER_TYPE_5));
        list.add(new ItemEntity(getResources().getString(R.string.audio_effect_setting_changetype_foreign),
                R.drawable.audio_effect_setting_changetype_foreign, AUDIO_VOICECHANGER_TYPE_6));
        list.add(new ItemEntity(getResources().getString(R.string.audio_effect_setting_changetype_kunsou),
                R.drawable.audio_effect_setting_changetype_kunsou, AUDIO_VOICECHANGER_TYPE_7));
        list.add(new ItemEntity(getResources().getString(R.string.audio_effect_setting_changetype_feizai),
                R.drawable.audio_effect_setting_changetype_feizai, AUDIO_VOICECHANGER_TYPE_8));
        list.add(new ItemEntity(getResources().getString(R.string.audio_effect_setting_changetype_dianliu),
                R.drawable.audio_effect_setting_changetype_dianliu, AUDIO_VOICECHANGER_TYPE_9));
        list.add(new ItemEntity(getResources().getString(R.string.audio_effect_setting_changetype_machine),
                R.drawable.audio_effect_setting_changetype_machine, AUDIO_VOICECHANGER_TYPE_10));
        list.add(new ItemEntity(getResources().getString(R.string.audio_effect_setting_changetype_kongling),
                R.drawable.audio_effect_setting_changetype_kongling, AUDIO_VOICECHANGER_TYPE_11));
    ...
    private List<ItemEntity> createReverbItems() {
        List<ItemEntity> list = new ArrayList<>();
        list.add(new ItemEntity(getResources().getString(R.string.audio_effect_setting_reverbtype_origin),
                R.drawable.audio_effect_setting_reverbtype_origin_high, AUDIO_REVERB_TYPE_0));
        list.add(new ItemEntity(getResources().getString(R.string.audio_effect_setting_reverbtype_ktv),
                R.drawable.audio_effect_setting_reverbtype_ktv, AUDIO_REVERB_TYPE_1));
        list.add(new ItemEntity(getResources().getString(R.string.audio_effect_setting_reverbtype_room),
                R.drawable.audio_effect_setting_reverbtype_room, AUDIO_REVERB_TYPE_2));
        list.add(new ItemEntity(getResources().getString(R.string.audio_effect_setting_reverbtype_meeting),
                R.drawable.audio_effect_setting_reverbtype_meeting, AUDIO_REVERB_TYPE_3));
        list.add(new ItemEntity(getResources().getString(R.string.audio_effect_setting_reverbtype_lowdeep),
                R.drawable.audio_effect_setting_reverbtype_lowdeep, AUDIO_REVERB_TYPE_4));
        list.add(new ItemEntity(getResources().getString(R.string.audio_effect_setting_reverbtype_hongliang),
                R.drawable.audio_effect_setting_reverbtype_hongliang, AUDIO_REVERB_TYPE_5));
        list.add(new ItemEntity(getResources().getString(R.string.audio_effect_setting_reverbtype_heavymetal),
                R.drawable.audio_effect_setting_reverbtype_heavymetal, AUDIO_REVERB_TYPE_6));
        list.add(new ItemEntity(getResources().getString(R.string.audio_effect_setting_reverbtype_cixing),
                R.drawable.audio_effect_setting_reverbtype_cixing, AUDIO_REVERB_TYPE_7));
        list.get(0).mIsSelected = true;
        return list;
    }
    ...
    public class RecyclerViewAdapter extends RecyclerView.Adapter<RecyclerViewAdapter.ViewHolder> {
        ...
        public class ViewHolder extends RecyclerView.ViewHolder {
             ...
             * @param listener
             */
            public void bind(final ItemEntity model, final int position, final OnItemClickListener listener) {
    ...
    private List<BGMItemEntity> createBGMItems() {
        ...
        list.add(new BGMItemEntity(getResources().getString(R.string.audio_effect_setting_surround_sound_test_1),
                ONLINE_BGM_FIRST, getResources().getString(R.string.audio_effect_setting_unknown)));
        list.add(new BGMItemEntity(getResources().getString(R.string.audio_effect_setting_surround_sound_test_2),
                ONLINE_BGM_SECOND, getResources().getString(R.string.audio_effect_setting_unknown)));
        list.add(new BGMItemEntity(getResources().getString(R.string.audio_effect_setting_surround_sound_test_3),
                ONLINE_BGM_THIRD, getResources().getString(R.string.audio_effect_setting_unknown)));
        return list;
    }
    ...
    public class BGMRecyclerViewAdapter extends RecyclerView.Adapter<BGMRecyclerViewAdapter.ViewHolder> {
        ...
        public class ViewHolder extends RecyclerView.ViewHolder {
            ...
            public void bind(final BGMItemEntity model, final int positon, final OnItemClickListener listener) {
    ...
    /**
     * Reset the params of audio effect.
     */
    public void reset() {
        mAudioEffectManager.stopPlayMusic(mBGMId);
        mBGMId = -1;
        ...
        mHandler.post(new Runnable() {
            ...
            public void run() {
                ...
                mTvTotalTime.setText(
                        "/" + formattedTime(mAudioEffectManager.getMusicDurationInMS(model.mPath) / 1000) + "");
                mImgbtnBGMPlay.setVisibility(VISIBLE);
                mImgbtnBGMPlay.setImageResource(R.drawable.audio_effect_setting_bgm_pause);
            }
        });
        final TXAudioEffectManager.AudioMusicParam audioMusicParam =
                new TXAudioEffectManager.AudioMusicParam(position, model.mPath);
