package com.tencent.liteav.demo.videouploader.common.view;
...
public class VideoWorkProgressFragment extends DialogFragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        mContentView = inflater.inflate(R.layout.layout_uploader_progress, null);
        mTvTips = (TextView) mContentView.findViewById(R.id.uploader_tv_msg);
        ...
        mIvStop = (ImageView) mContentView.findViewById(R.id.uploader_iv_stop);
        mPbLoading = (NumberProgressBar) mContentView.findViewById(R.id.uploader_pb_loading);
