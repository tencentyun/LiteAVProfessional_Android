...
public class AudioEffectPanel extends FrameLayout {
    ...
    private HorizontalListView mRVAuidoChangeType;
    private HorizontalListView mRVAudioReverbType;
    private RecyclerView mRVAudioBGM;
    private SeekBar  mSbMicVolume;
    private SeekBar  mSbBGMVolume;
    private SeekBar  mSbPitchLevel;
    private MyListAdapter mChangerRVAdapter;
    private MyListAdapter mReverbRVAdapter;
    ...
    public AudioEffectPanel(Context context, AttributeSet attrs) {
        super(context, attrs);
        mContext = context;
        LayoutInflater.from(context).inflate(R.layout.live_link_mic_new_audio_effect_panel, this);
        initView();
    }
    ...
    private void initView() {
        ...
        mRVAudioReverbType = (HorizontalListView) findViewById(R.id.audio_reverb_type_rv);
        mRVAuidoChangeType = (HorizontalListView) findViewById(R.id.audio_change_type_rv);
        ...
        // 选变声
        mChangerRVAdapter = new MyListAdapter(mContext, mChangerItemEntityList, new OnItemClickListener() {
            @Override
        ...
        // 选混响
        mReverbRVAdapter = new MyListAdapter(mContext, mReverbItemEntityList, new OnItemClickListener() {
            @Override
            public void onItemClick(int position) {
    ...
    public class MyListAdapter extends BaseAdapter {
        ...
        public MyListAdapter(Context context, List<ItemEntity> list,
        ...
        public View getView(final int position, View convertView, ViewGroup viewGroup) {
            //加载布局为一个视图
            View view = LayoutInflater.from(context).inflate(R.layout.live_link_mic_new_audio_main_entry_item,null);
            ItemEntity item = (ItemEntity) getItem(position);
            //在view 视图中查找 组件
            CircleImageView mItemImg = (CircleImageView) view.findViewById(R.id.img_item);
            TextView mTitleTv = (TextView) view.findViewById(R.id.tv_title);

            //为Item 里面的组件设置相应的数据
            mItemImg.setImageResource(item.mIconId);
    ...
    public class RecyclerViewAdapter extends
        ...
        public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            ...
            View view = inflater.inflate(R.layout.live_link_mic_new_audio_main_entry_item, parent, false);
    ...
    public class BGMRecyclerViewAdapter extends
        ...
        public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            Context        context  = parent.getContext();
            LayoutInflater inflater = LayoutInflater.from(context);
            View view = inflater.inflate(R.layout.live_link_mic_new_audio_bgm_entry_item, parent, false);
            ViewHolder viewHolder = new ViewHolder(view);
            return viewHolder;
        }
