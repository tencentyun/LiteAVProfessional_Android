...
public class TCVideoSettingActivity extends Activity implements View.OnClickListener {
    ...
    private int          mFps              = 30;             // 帧率
    private int          mGop              = 1;              // 关键帧间隔
    ...
    private void initView() {
        ...
        mRadioVideoResolution1080p = (RadioButton) findViewById(R.id.rb_video_resolution_1080p);
    ...
    private void initListener() {
        ...
        mGroupVideoResolution.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(RadioGroup radioGroup, @IdRes int i) {
                ...
                } else if (i == mRadioVideoResolution1080p.getId()) {
                    mRecordResolution = TXRecordCommon.VIDEO_RESOLUTION_1080_1920;
                } else {
    ...
    private void recommendQualitySD() {
        ...
        mTextRecommendFps.setText("30");
        mTextRecommendGop.setText("1");
