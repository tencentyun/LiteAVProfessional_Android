...
public class TCVideoEditerListAdapter extends RecyclerView.Adapter<TCVideoEditerListAdapter.ViewHolder> {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = View.inflate(parent.getContext(), R.layout.ugcjoin_item_ugc_video, null);
        ...
        holder.thumb.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (checkImageValid(v)) {
                    ...
                    ToastUtil.toastLongMessage(mContext.getString(R.string.ugcjoin_image_is_invalid));
                }
            }
        });
    }

    private boolean checkImageValid(View view) {
