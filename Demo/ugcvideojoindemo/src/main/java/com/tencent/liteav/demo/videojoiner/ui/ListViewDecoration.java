...
import com.tencent.liteav.demo.videojoiner.ui.swipemenu.ResCompat;
...
public class ListViewDecoration extends RecyclerView.ItemDecoration {
    ...
    public ListViewDecoration(Context context) {
        mDrawable = ResCompat.getDrawable(context, R.drawable.ugckit_swipe_menu_divider_recycler);
    }
