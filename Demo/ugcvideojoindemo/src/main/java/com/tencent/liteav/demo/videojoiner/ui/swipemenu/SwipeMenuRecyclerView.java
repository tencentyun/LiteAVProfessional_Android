package com.tencent.liteav.demo.videojoiner.ui.swipemenu;
...
import com.tencent.liteav.demo.videojoiner.ui.swipemenu.touch.DefaultItemTouchHelper;
import com.tencent.liteav.demo.videojoiner.ui.swipemenu.touch.OnItemMoveListener;
import com.tencent.liteav.demo.videojoiner.ui.swipemenu.touch.OnItemMovementListener;
import com.tencent.liteav.demo.videojoiner.ui.swipemenu.touch.OnItemStateChangedListener;
...
public class SwipeMenuRecyclerView extends RecyclerView {
    ...
    public static final int LEFT_DIRECTION    = 1;    // Left menu.
    public static final int RIGHT_DIRECTION   = -1;  // Right menu.
    private static final int INVALID_POSITION = -1;  // Invalid position.

    protected int   mScaleTouchSlop;
    protected int   mOldTouchedPosition = INVALID_POSITION;
    private int     mDownX;
    private int     mDownY;
    private boolean mAllowSwipeDelete   = false;
    ...
    public void setItemViewSwipeEnabled(boolean canSwipe) {
        initializeItemTouchHelper();
        mAllowSwipeDelete = canSwipe; // swipe and menu conflict.
    ...
    public boolean onInterceptTouchEvent(MotionEvent e) {
        ...
        if (mAllowSwipeDelete)  // swipe and menu conflict.
