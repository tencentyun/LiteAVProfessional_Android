...
import com.tencent.liteav.demo.videorecord.utils.VideoMaterialDownloadProgress;
...
//    };
    ...
    public BeautySettingPannel(Context context, AttributeSet attrs) {
        super(context, attrs);
        View view = LayoutInflater.from(context).inflate(R.layout.vr_beauty_pannel, this);
        mContext = context;
        initView(view);
    }
