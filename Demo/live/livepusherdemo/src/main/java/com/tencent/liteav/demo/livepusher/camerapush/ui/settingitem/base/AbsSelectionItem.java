...
public abstract class AbsSelectionItem extends AbsBaseItem {
    ...
    private void initView(Context context) {
        LayoutInflater.from(context).inflate(R.layout.livepusher_item_setting_selection, this, true);
        ...
        mAdapter = new ArrayAdapter<String>(getContext(),
                R.layout.livepusher_item_setting_selection_textview, mTextList);
    ...
    public class SpinnerListener implements AdapterView.OnItemSelectedListener, OnTouchListener {
