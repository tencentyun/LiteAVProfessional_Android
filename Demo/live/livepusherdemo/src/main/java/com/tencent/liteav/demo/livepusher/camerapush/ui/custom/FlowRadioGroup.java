package com.tencent.liteav.demo.livepusher.camerapush.ui.custom;
...
public class FlowRadioGroup extends RadioGroup {
    ...
    protected void onLayout(boolean changed, int l, int t, int r, int b) {
        ...
        for (int i = 0; i < count; i++) {
            ...
            int w = preLeft + params.leftMargin + child.getMeasuredWidth() + params.rightMargin + getPaddingRight();
            if (w > (r - l)) {
                //重置
