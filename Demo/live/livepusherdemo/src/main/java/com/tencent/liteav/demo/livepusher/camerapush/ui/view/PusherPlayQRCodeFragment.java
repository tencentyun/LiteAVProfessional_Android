...
public class PusherPlayQRCodeFragment extends DialogFragment {
    ...
    public void setQRCodeURL(String flvPlayURL, String rtmpPlayURL, String hlsPlayURL, String rtcPlayURL) {
        mRTCPlayURL = rtcPlayURL;
        mQRCodeURL[0] = flvPlayURL;
        mQRCodeURL[1] = rtmpPlayURL;
        mQRCodeURL[2] = hlsPlayURL;
        if (!TextUtils.isEmpty(rtcPlayURL)) {
            if (rtmpPlayURL != null) {
                mQRCodeURL[3] = rtmpPlayURL.replace("rtmp://", "webrtc://");
            }
            mQRCodeURL[4] = rtcPlayURL;
        } else {
            mQRCodeURL[3] = rtmpPlayURL.replace("rtmp://", "webrtc://");
        }
    }
    ...
    private void initViews(View view) {
        ...
        if (TextUtils.isEmpty(mRTCPlayURL)) {
            mRadioButtons[3] = view.findViewById(R.id.livepusher_rb_leb);
            mRadioButtons[3].setText(getString(R.string.livepusher_leb));
            mRadioButtons[4] = view.findViewById(R.id.livepusher_rb_realtime);
            mRadioButtons[4].setVisibility(View.GONE);
        } else {
            mRadioButtons[3] = view.findViewById(R.id.livepusher_rb_leb);
            mRadioButtons[3].setText(getString(R.string.livepusher_leb));
            mRadioButtons[4] = view.findViewById(R.id.livepusher_rb_realtime);
            mRadioButtons[4].setVisibility(View.VISIBLE);
            mRadioButtons[4].setText("RTC");
        }
