...
public class SelectionSettingItem extends BaseSettingItem {
    private static final String         TAG = "SelectionSettingItem";
    ...
    public SelectionSettingItem(Context context,
        ...
        mItemViewHolder = new ItemViewHolder(
                mInflater.inflate(R.layout.live_link_mic_new_item_setting_selection, null)
        );
        mListener = listener;
    }
    ...
    public class ItemViewHolder {
        ...
        public ItemViewHolder(@NonNull final View itemView) {
            ...
            mAdapter = new ArrayAdapter<>(mContext, R.layout.live_link_mic_new_item_setting_selection_textview, mItemText.contentText);
