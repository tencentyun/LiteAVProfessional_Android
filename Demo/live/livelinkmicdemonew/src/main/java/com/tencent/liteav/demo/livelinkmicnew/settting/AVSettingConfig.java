...
public class AVSettingConfig {
    ...
    public              Map<String, MainItemRenderView> playerViewScanMap    = new HashMap<>();    // 二维码扫码播放地址判重用
    ...
    class AudioConfig implements Serializable {
        private final static String PER_DATA       = "per_audio_data_v2";
        private final static String PER_DATA_PARAM = "per_audio_param_v2";
        private final static String PER_SAVE_FLAG  = "per_save_flag_v2";
    ...
    class VideoConfig implements Serializable {
        ...
        private final static String                              PER_DATA                    = "per_video_data_v2";
        private final static String                              PER_DATA_PARAM              = "per_video_param_v2";
        private final static String                              PER_SAVE_FLAG               = "per_save_flag_v2";
        // 分辨率
