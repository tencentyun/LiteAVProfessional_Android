...
public class LiveRoomActivity extends AppCompatActivity implements LiveRoomActivityInterface {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.mlvb_liveroom_link_button).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                IntentUtils.safeStartActivity(LiveRoomActivity.this, intent);
            }
        });
    ...
    protected void onDestroy() {
        mMLVBLiveRoom.setListener(null);
        mMLVBLiveRoom.logout();
        super.onDestroy();
    }
    ...
    private void internalInitializeLiveRoom() {
        ...
        loginInfo.userID = UserModelManager.getInstance().getUserModel().userId;
        loginInfo.userSig = UserModelManager.getInstance().getUserModel().userSig;
        loginInfo.userName = mUserName;
        loginInfo.userAvatar = mUserAvatar;
        LiveRoomActivity.this.mUserId = UserModelManager.getInstance().getUserModel().userId;
