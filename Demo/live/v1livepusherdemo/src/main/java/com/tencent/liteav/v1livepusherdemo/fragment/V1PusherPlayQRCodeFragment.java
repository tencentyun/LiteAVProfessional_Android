 ...
 * 推流对应的拉流二维码
 */
public class V1PusherPlayQRCodeFragment extends DialogFragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        return inflater.inflate(R.layout.v1livepusher_qr_code_fragment, container, false);
    }
    ...
    public void setQRCodeURL(String flvPlayURL, String rtmpPlayURL, String hlsPlayURL, String aacPlayURL) {
        mQRCodeURL[0] = flvPlayURL;
        mQRCodeURL[1] = rtmpPlayURL;
        mQRCodeURL[2] = hlsPlayURL;
        mQRCodeURL[3] = aacPlayURL;
        if (rtmpPlayURL != null) {
    ...
    private void initViews(View view) {
        mRadioButtons[0] = view.findViewById(R.id.v1livepusher_rb_flv);
        mRadioButtons[0].setText("flv");
        mRadioButtons[1] = view.findViewById(R.id.v1livepusher_rb_rtmp);
        mRadioButtons[1].setText("rtmp");
        mRadioButtons[2] = view.findViewById(R.id.v1livepusher_rb_hls);
        mRadioButtons[2].setText("hls");
        mRadioButtons[3] = view.findViewById(R.id.v1livepusher_rb_realtime);
        mRadioButtons[3].setText("aac");
        mRadioButtons[4] = view.findViewById(R.id.v1livepusher_rb_leb);
        mRadioButtons[4].setText(getString(R.string.v1livepusher_leb));
        ...
        mImageQRCode = (ImageView) view.findViewById(R.id.v1livepusher_iv_qr_code);
        mLayoutCopy = (LinearLayout) view.findViewById(R.id.v1livepusher_ll_copy);
        mLayoutCopy.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(getActivity(), R.string.v1livepusher_primary_clip, Toast.LENGTH_SHORT).show();
            }
        });

        mButtonClose = (Button) view.findViewById(R.id.v1livepusher_btn_close);
