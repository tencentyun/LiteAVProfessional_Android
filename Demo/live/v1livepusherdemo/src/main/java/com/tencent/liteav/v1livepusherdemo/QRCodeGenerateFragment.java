...
public class QRCodeGenerateFragment extends DialogFragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        return inflater.inflate(R.layout.v1livepusher_fragment_play_qr_code, container, false);
    }
    ...
    private void initViews(View view) {
        ...
        mLayoutCopy.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(getActivity(), getString(R.string.v1livepusher_screen_primary_clip), Toast.LENGTH_SHORT)
                        .show();
            }
        });
