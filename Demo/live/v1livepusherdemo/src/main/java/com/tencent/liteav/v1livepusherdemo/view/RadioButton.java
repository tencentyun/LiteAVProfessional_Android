...
public class RadioButton extends LinearLayout implements Checkable {
    ...
    private void initView() {
        ...
        mImageView.setBackgroundResource(R.drawable.v1livepusher_radio_btn_no_checked);
        ...
        mTextView.setTextColor(getResources().getColor(R.color.v1livepusher_text_gray));
    ...
    public void setChecked(boolean checked) {
        ...
        setFocusable(false);
        if (checked) {
            mImageView.setBackgroundResource(R.drawable.v1livepusher_radio_btn_checked);
