...
public class QRCodeScanActivity extends Activity implements ZXingScannerView.ResultHandler {
    ...
    public void onCreate(Bundle state) {
        ...
        ViewGroup view = (ViewGroup) View.inflate(this, R.layout.v1livepusher_activity_qr_code_scan, null);
    ...
    public void onResume() {
        ...
        PermissionUtils.permission(PermissionConstants.CAMERA).callback(new PermissionUtils.FullCallback() {
            ...
            public void onDenied(List<String> permissionsDeniedForever, List<String> permissionsDenied) {
                ToastUtils.showShort(R.string.v1livepusher_camera);
                finish();
            }
        }).request();
    }
    ...
    public void onClick(View view) {
        if (view.getId() == R.id.v1livepusher_ibtn_back) {
            finish();
        }
    }
