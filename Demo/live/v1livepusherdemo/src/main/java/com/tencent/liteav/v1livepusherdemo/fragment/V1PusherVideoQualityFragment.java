...
import com.tencent.liteav.v1livepusherdemo.view.RadioSelectView;
import com.tencent.rtmp.TXLiveConstants;

/**
 * 画质设置面板
 */
public class V1PusherVideoQualityFragment extends BottomSheetDialogFragment {
    ...
    private void initViews(RadioSelectView view) {
        view.setData(getResources().getStringArray(R.array.v1livepusher_video_quality_list), mQualityIndex);
        view.setTitle(getString(R.string.v1livepusher_video_quality));
