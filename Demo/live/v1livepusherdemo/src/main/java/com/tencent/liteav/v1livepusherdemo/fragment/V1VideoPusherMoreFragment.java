 ...
 *
 */
public class V1VideoPusherMoreFragment extends DialogFragment implements CompoundButton.OnCheckedChangeListener {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        return inflater.inflate(R.layout.v1livepusher_video_more_fragment, container, false);
    }
    ...
    public void onViewCreated(final View view, @Nullable Bundle savedInstanceState) {
        ...
        mCbPrivateModel = ((CheckBox) view.findViewById(R.id.v1livepusher_pusher_cb_private_mode));
        mCbPrivateModel.setOnCheckedChangeListener(this);
        mCbPrivateModel.setChecked(mPrivateModel);
        CheckBox cbMuteAudio = ((CheckBox) view.findViewById(R.id.v1livepusher_pusher_cb_mute_audio));
        cbMuteAudio.setOnCheckedChangeListener(this);
        cbMuteAudio.setChecked(mMuteAudio);
        CheckBox cbMirror = ((CheckBox) view.findViewById(R.id.v1livepusher_pusher_cb_mirror));
        cbMirror.setOnCheckedChangeListener(this);
        cbMirror.setChecked(mMirrorEnable);
        CheckBox cbFlashlight = ((CheckBox) view.findViewById(R.id.v1livepusher_pusher_cb_flash_light));
        cbFlashlight.setOnCheckedChangeListener(this);
        cbFlashlight.setChecked(mFlashEnable);
        CheckBox cbDebugInfo = ((CheckBox) view.findViewById(R.id.v1livepusher_pusher_cb_debug_info));
        cbDebugInfo.setOnCheckedChangeListener(this);
        cbDebugInfo.setChecked(mDebugInfo);
        CheckBox cbWaterMark = ((CheckBox) view.findViewById(R.id.v1livepusher_pusher_cb_water_mark));
        cbWaterMark.setOnCheckedChangeListener(this);
        cbWaterMark.setChecked(mWaterMarkEnable);
        CheckBox cbFocus = ((CheckBox) view.findViewById(R.id.v1livepusher_pusher_cb_focus));
        cbFocus.setOnCheckedChangeListener(this);
        cbFocus.setChecked(mFocusEnable);
        CheckBox cbZoom = ((CheckBox) view.findViewById(R.id.v1livepusher_pusher_cb_zoom));
        cbZoom.setOnCheckedChangeListener(this);
        cbZoom.setChecked(mZoomEnable);
        CheckBox cbAudio = ((CheckBox) view.findViewById(R.id.v1livepusher_pusher_cb_pure_audio));
        cbAudio.setOnCheckedChangeListener(this);
        cbAudio.setChecked(mPureAudio);

        mLlOrientation = (LinearLayout) view.findViewById(R.id.v1livepusher_pusher_ll_orientation);
        mCbOrientation = ((CheckBox) view.findViewById(R.id.v1livepusher_pusher_cb_orientation));
        ...
        view.findViewById(R.id.v1livepusher_pusher_btn_snapshot).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
        ...
        view.findViewById(R.id.v1livepusher_btn_send).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                OnMoreChangeListener listener = getListener();
                if (listener != null) {
                    EditText editText = (EditText) view.findViewById(R.id.v1livepusher_et_message);
        ...
        view.findViewById(R.id.v1livepusher_btn_send_loop).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                OnMoreChangeListener listener = getListener();
                if (listener != null) {
                    ...
                    listener.onClickLoopSendSEI(message);
                }
            }
        });
    }
