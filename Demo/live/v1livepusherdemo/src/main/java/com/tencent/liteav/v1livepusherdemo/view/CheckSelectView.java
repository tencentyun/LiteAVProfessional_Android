...
public class CheckSelectView extends LinearLayout {
    ...
    public void setCheckedNoEvent(int position, boolean enable) {
        if (position >= 0 && position < getChildCount()) {
            View child = getChildAt(position);
            if (child instanceof ItemView) {
                ((ItemView) child).setCheckedNoEvent(enable);
            }
        }
    }
    ...
    private class ItemView extends RelativeLayout {
        ...
        private void init() {
            ...
            mSwitchButton.setThumbDrawableRes(R.drawable.v1livepusher_thumb);
            mSwitchButton.setBackDrawableRes(R.drawable.v1livepusher_swicth_button_selector);
        ...
        public void setCheckedNoEvent(boolean enable) {
            mSwitchButton.setCheckedNoEvent(enable);
        }
