...
public class LogInfoWindow extends PopupWindow {
    ...
    private void initView() {
        View rootView = LayoutInflater.from(mContext).inflate(R.layout.v1livepusher_view_loginfo, null);
        setContentView(rootView);
        mLayout = rootView.findViewById(R.id.v1livepusher_ll_layout);
        mImageNetSpeed = rootView.findViewById(R.id.v1livepusher_iv_net_speed);
    }
    ...
    private void initData() {
        ...
        setLogInfoList(list);
        mImageNetSpeed.setImageResource(R.drawable.v1livepusher_ic_net_speed0);
    }
    ...
    private void handleLogStatus(Bundle status) {
        ...
        if (mNetSpeed >= 0 && mNetSpeed < 3) {
            mImageNetSpeed.setImageResource(R.drawable.v1livepusher_ic_net_speed5);
        } else if (mNetSpeed > 3 && mNetSpeed <= queMax * 0.2) {
            mImageNetSpeed.setImageResource(R.drawable.v1livepusher_ic_net_speed4);
        } else if (mNetSpeed > queMax * 0.2 && mNetSpeed <= queMax * 0.4) {
            mImageNetSpeed.setImageResource(R.drawable.v1livepusher_ic_net_speed3);
        } else if (mNetSpeed > queMax * 0.4 && mNetSpeed <= queMax * 0.6) {
            mImageNetSpeed.setImageResource(R.drawable.v1livepusher_ic_net_speed2);
        } else if (mNetSpeed > queMax * 0.6 && mNetSpeed <= queMax * 0.8) {
            mImageNetSpeed.setImageResource(R.drawable.v1livepusher_ic_net_speed1);
        ...
        if (message != null && !message.isEmpty()) {
            switch (eventId) {
                ...
                case TXLiveConstants.PUSH_EVT_OPEN_CAMERA_SUCC:     // 打开摄像头成功 step3
                    ...
                    mCurrentSuccessStep =
                            (mCurrentSuccessStep != LogInfo.ID_STEP_5 ? LogInfo.ID_STEP_3 : LogInfo.ID_STEP_5);
                    break;
                case TXLiveConstants.PUSH_EVT_START_VIDEO_ENCODER:  // 编码器启动 step4
                    ...
                    if (mode == ENCODER_HARD) {                     // 硬编码器1 软编码器2
                        text = getResources().getString(R.string.v1livepusher_hardcode);
                    } else {
                        text = getResources().getString(R.string.v1livepusher_softcode);
                    }
                    ...
                    mCurrentSuccessStep =
                            (mCurrentSuccessStep != LogInfo.ID_STEP_5 ? LogInfo.ID_STEP_4 : LogInfo.ID_STEP_5);
                    break;
    ...
    private class ItemView extends LinearLayout {
        ...
        private void init() {
            ...
            mTextView.setTextColor(getResources().getColor(R.color.v1livepusher_white));
        ...
        public void setStatus(int status) {
            switch (status) {
                ...
                case LogInfo.STATUS_FAIL:
                    ...
                    mImageView.setBackgroundResource(R.drawable.v1livepusher_ic_red);
                    break;
                case LogInfo.STATUS_SUCCESS:
                    mImageView.setVisibility(View.VISIBLE);
                    mImageView.setBackgroundResource(R.drawable.v1livepusher_ic_green);
                    break;
                default :
    ...
    public static class LogInfo {
        ...
        public static LogInfo createModelLogInfo(String value) {
            return new LogInfo(ID_MODEL, getResources().getString(R.string.v1livepusher_model), value);
        }

        public static LogInfo createVersionLogInfo(String value) {
            return new LogInfo(ID_VERSION, getResources().getString(R.string.v1livepusher_version), value);
        }

        public static LogInfo createCodingRate(String value) {
            return new LogInfo(ID_CODING_RATE, getResources().getString(R.string.v1livepusher_coding_rate), value);
        }

        public static LogInfo createUploadSpeedLogInfo(String value) {
            return new LogInfo(ID_DOWNLOAD_SPEED, getResources().getString(R.string.v1livepusher_upload_speed), value);
        }

        public static LogInfo createFpsGopLogInfo(String value) {
            return new LogInfo(ID_FPS_GOP, getResources().getString(R.string.v1livepusher_fps), value);
        }

        public static LogInfo createStep1LogInfo(String value) {
            return new LogInfo(ID_STEP_1, STATUS_FAIL, getResources().getString(R.string.v1livepusher_step1), value);
        }

        public static LogInfo createStep1LogInfo(int status) {
            return new LogInfo(ID_STEP_1, status, getResources().getString(R.string.v1livepusher_step1), "");
        }

        public static LogInfo createStep2LogInfo(String value) {
            return new LogInfo(ID_STEP_2, STATUS_FAIL, getResources().getString(R.string.v1livepusher_step2), value);
        }

        public static LogInfo createStep2LogInfo(int status) {
            return new LogInfo(ID_STEP_2, status, getResources().getString(R.string.v1livepusher_step2), "");
        }

        public static LogInfo createStep3LogInfo(String value) {
            return new LogInfo(ID_STEP_3, STATUS_FAIL, getResources().getString(R.string.v1livepusher_step3), value);
        }

        public static LogInfo createStep3LogInfo(int status) {
            return new LogInfo(ID_STEP_3, status, getResources().getString(R.string.v1livepusher_step3), "");
        }

        public static LogInfo createStep4LogInfo(String value) {
            return new LogInfo(ID_STEP_4, STATUS_FAIL, getResources().getString(R.string.v1livepusher_step4), value);
        }

        public static LogInfo createStep4LogInfo(int status) {
            return new LogInfo(ID_STEP_4, status, getResources().getString(R.string.v1livepusher_step4), "");
        }

        public static LogInfo createStep5LogInfo(String value) {
            return new LogInfo(ID_STEP_5, STATUS_FAIL, getResources().getString(R.string.v1livepusher_step5), value);
        }

        public static LogInfo createStep5LogInfo(int status) {
            return new LogInfo(ID_STEP_5, status, getResources().getString(R.string.v1livepusher_step5), "");
        }
