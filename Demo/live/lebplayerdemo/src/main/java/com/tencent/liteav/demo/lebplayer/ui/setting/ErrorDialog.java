...
public class ErrorDialog extends DialogFragment {
    ...
    public static ErrorDialog showMsgDialog(Activity activity, int code) {
        ...
        switch (code) {
            case V2TXLiveCode.V2TXLIVE_OK:
                msg = activity.getString(R.string.lebplayer_msg_success);
                break;
            case V2TXLiveCode.V2TXLIVE_ERROR_REFUSED:
                msg = activity.getString(R.string.lebplayer_msg_error_refused);
                break;
            case V2TXLiveCode.V2TXLIVE_ERROR_INVALID_PARAMETER:
                msg = activity.getString(R.string.lebplayer_msg_error_invalid_parameter);
                break;
            case V2TXLiveCode.V2TXLIVE_ERROR_NOT_SUPPORTED:
                msg = activity.getString(R.string.lebplayer_msg_error_not_supported);
                break;
            case V2TXLiveCode.V2TXLIVE_ERROR_FAILED:
                msg = activity.getString(R.string.lebplayer_msg_error_failed);
                break;
        }
        bundle.putString("msg", msg);
        fragment.setArguments(bundle);
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        return inflater.inflate(R.layout.lebplayer_fragment_error_dialog, container, false);
    }
