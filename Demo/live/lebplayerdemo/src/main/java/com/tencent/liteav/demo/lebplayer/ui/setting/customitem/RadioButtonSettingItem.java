package com.tencent.liteav.demo.lebplayer.ui.setting.customitem;
...
public class RadioButtonSettingItem extends BaseSettingItem {
    private static final String              TAG = "RadioButtonSettingItem";
    ...
    public RadioButtonSettingItem(Context context,
        ...
        mRadioItemViewHolder = new RadioItemViewHolder(
                mInflater.inflate(R.layout.lebplayer_item_setting_radio, null)
        );
    }
    ...
    public class RadioItemViewHolder {
        ...
        private RadioButton createRadioButton(String name, int id) {
            ...
            radioButton.setButtonDrawable(R.drawable.lebplayer_bg_checkbox);
            radioButton.setId(id);
            radioButton.setText(name);
            radioButton.setTextSize(TypedValue.COMPLEX_UNIT_SP, 15);
            radioButton.setTextColor(mContext.getResources().getColor(R.color.lebplayer_white));
