...
public class SettingItemView extends RelativeLayout {
    ...
    private void initSwitch() {
        ...
        mSwitchButton.setThumbDrawableRes(R.drawable.liveplayer_thumb);
        mSwitchButton.setBackDrawableRes(R.drawable.liveplayer_switch_button_selector);
    ...
    private void initButton() {
        ...
        mButton.setBackgroundResource(R.drawable.liveplayer_btn_bg);
    ...
    private void initRadio() {
        ...
        mVariableRadioSelectorView.setTextColor(getResources().getColor(R.color.liveplayer_text_gray), Color.BLACK);
