...
public class PlayerSettingFragment extends BottomSheetDialogFragment implements View.OnClickListener {
    ...
    public PlayerSettingFragment(Context context) {
        mContext = context;
        mView = View.inflate(context, R.layout.liveplayer_fragment_live_player_setting, null);
        mContentView = mView.findViewById(R.id.liveplayer_ll_content);
    }
    ...
    public void onClick(View v) {
        int id = v.getId();
        if (id == R.id.liveplayer_btn_close) {
            dismissAllowingStateLoss();
        }
    }

    private void initViews(View view) {
        view.findViewById(R.id.liveplayer_btn_close).setOnClickListener(this);
    }
}
