...
public class VariableRadioSelectorView extends LinearLayout {
    ...
    private void initialize(Context context) {
        mContext = context;
        mNormalColor = getResources().getColor(R.color.v1liveplayer_text_gray);
        mSelectColor = getResources().getColor(R.color.v1liveplayer_white);
    }
    ...
    public class RadioButton extends LinearLayout implements Checkable {
        ...
        private void initView() {
            ...
            mImageView.setBackgroundResource(R.drawable.v1liveplayer_radio_btn_no_checked);
            ...
            mTextView.setTextColor(getResources().getColor(R.color.v1liveplayer_text_gray));
        ...
        public void setChecked(boolean checked) {
            mChecked = checked;
            if (checked) {
                mImageView.setBackgroundResource(R.drawable.v1liveplayer_radio_btn_checked);
