...
public class VideoWorkProgressFragment extends DialogFragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        mContentView = inflater.inflate(R.layout.layout_editer_progress, null);
        mTvTips = (TextView) mContentView.findViewById(R.id.editer_tv_msg);
        ...
        mIvStop = (ImageView) mContentView.findViewById(R.id.editer_iv_stop);
        mPbLoading = (NumberProgressBar) mContentView.findViewById(R.id.editer_pb_loading);
