...
public class TRTCLiveEnterActivity extends Activity {
    ...
    private void initView() {
        ...
        mRoleItem = new RadioButtonSettingItem(this, new BaseSettingItem.ItemText(getString(R.string.trtcdemo_role_select), getString(R.string.trtcdemo_anchor), getString(R.string.trtcdemo_audience)),
                new RadioButtonSettingItem.SelectedListener() {
                    @Override
                    public void onSelected(int index) {
                    }
                });
        mRoleItem.setPaddingTop(SizeUtils.dp2px(15));
        mSettingItemList.add(mRoleItem);

        mVideoInputItem = new RadioButtonSettingItem(this, new BaseSettingItem.ItemText(getString(R.string.trtcdemo_video_input), getString(R.string.trtcdemo_camera), getString(R.string.trtcdemo_video_file), getString(R.string.trtcdemo_screen_capture), getString(R.string.trtcdemo_null)),
                new RadioButtonSettingItem.SelectedListener() {
                    @Override
                    public void onSelected(int index) {
        ...
        mAudioInputItem = new RadioButtonSettingItem(this, new BaseSettingItem.ItemText(getString(R.string.trtcdemo_audio_input), getString(R.string.trtcdemo_sdk_capture), getString(R.string.trtcdemo_custom_capture), getString(R.string.trtcdemo_null)), null);
    ...
    private void startJoinRoomInternal(final String roomId, final String userId) {
        ...
        intent.putExtra(KEY_ROLE, mRoleItem.getSelected() == 0 ? TRTCCloudDef.TRTCRoleAnchor : TRTCCloudDef.TRTCRoleAudience);
        ...
        intent.putExtra(KEY_VIDEO_INPUT_TYPE, mVideoInputItem.getSelected());
        intent.putExtra(KEY_AUDIO_INPUT_TYPE, mAudioInputItem.getSelected());
