...
import static com.tencent.liteav.trtcdemo.model.bean.Constant.KEY_AUDIO_PARALLEL_MAX_COUNT;
...
import com.tencent.liteav.trtcdemo.ui.widget.settingitem.enteritem.AudioParallelMaxCountItem;
...
import com.tencent.liteav.trtcdemo.ui.widget.settingitem.enteritem.CustomVideoPreprocessItem;
...
public class TRTCCallEnterActivity extends Activity {
    private static final String TAG = "TRTCCallEnterActivity";
    ...
    private static final FrameConfig[] CUSTOM_RENDER_SUPPORT_CONFIGS = {
            new FrameConfig("RGBA - ByteArray", TRTCCloudDef.TRTC_VIDEO_PIXEL_FORMAT_RGBA,
                    TRTCCloudDef.TRTC_VIDEO_BUFFER_TYPE_BYTE_ARRAY),
            new FrameConfig("RGBA - ByteBuffer", TRTCCloudDef.TRTC_VIDEO_PIXEL_FORMAT_RGBA,
                    TRTCCloudDef.TRTC_VIDEO_BUFFER_TYPE_BYTE_BUFFER),
            new FrameConfig("I420 - ByteArray", TRTCCloudDef.TRTC_VIDEO_PIXEL_FORMAT_I420,
                    TRTCCloudDef.TRTC_VIDEO_BUFFER_TYPE_BYTE_ARRAY),
            new FrameConfig("I420 - ByteBuffer", TRTCCloudDef.TRTC_VIDEO_PIXEL_FORMAT_I420,
                    TRTCCloudDef.TRTC_VIDEO_BUFFER_TYPE_BYTE_BUFFER),
            new FrameConfig("Texture", TRTCCloudDef.TRTC_VIDEO_PIXEL_FORMAT_Texture_2D,
    ...
    private void initView() {
        ...
        // 云端环境
        mNetEnvItem = new NetEnvItem(this, getString(R.string.trtcdemo_net_env), getString(R.string.trtcdemo_product)
                , getString(R.string.trtcdemo_test), getString(R.string.trtcdemo_experience));
        mSettingItemList.add(mNetEnvItem);

        // 主路视频输入
        mMainVideoInputItem = new MainVideoInputItem(this, getString(R.string.trtcdemo_main_video_input),
                getString(R.string.trtcdemo_camera), getString(R.string.trtcdemo_video_file),
                getString(R.string.trtcdemo_screen_capture), getString(R.string.trtcdemo_null)) {
            @Override
        ...
        // 辅路视频输入
        mSubVideoInputItem = new SubVideoInputItem(this, getString(R.string.trtcdemo_sub_video_input),
                getString(R.string.trtcdemo_null), getString(R.string.trtcdemo_screen_capture)) {
            @Override
            public void onSelected(int index) {
                super.onSelected(index);
                if (index == 1) {
        ...
        mCameraCaptureItem = new CameraCaptureItem(this, getString(R.string.trtcdemo_camera_capture),
                getString(R.string.trtcdemo_camera_capture_auto),
                getString(R.string.trtcdemo_camera_capture_performance),
                getString(R.string.trtcdemo_camera_capture_high), getString(R.string.trtcdemo_camera_capture_custom)) {
            @Override
            public void onSelected(int index) {
                if (index == 3) {
        ...
        mAudioInputItem = new AudioInputItem(this, getString(R.string.trtcdemo_audio_input),
                getString(R.string.trtcdemo_sdk_capture), getString(R.string.trtcdemo_custom_capture),
        ...
        mGLContextItem = new GLContextItem(this, true, getString(R.string.trtcdemo_custom_render_glcontext));
        mSettingItemList.add(mGLContextItem);
        mGLContextItem.setVisibility(View.GONE);

        mCustomVideoPreprocessUseRenderItem = new CustomVideoPreprocessItem(this, true,
                getString(R.string.trtcdemo_custom_render_use_api));
        mSettingItemList.add(mCustomVideoPreprocessUseRenderItem);
        mCustomVideoPreprocessUseRenderItem.setVisibility(View.GONE);

        // 视频接收
        mVideoReceivedItem = new VideoReceivedItem(this, getString(R.string.trtcdemo_video_receive),
                getString(R.string.trtcdemo_auto), getString(R.string.trtcdemo_manual));
        mSettingItemList.add(mVideoReceivedItem);

        // 音频接收
        mAudioReceivedItem = new AudioReceivedItem(this, getString(R.string.trtcdemo_audio_receive),
                getString(R.string.trtcdemo_auto), getString(R.string.trtcdemo_manual));
        mSettingItemList.add(mAudioReceivedItem);

        //流控方案
        mQosModeItem = new OtherQosModeItem(this, getString(R.string.trtcdemo_qos_mode),
                getString(R.string.trtcdemo_control_client), getString(R.string.trtcdemo_control_server));
        mSettingItemList.add(mQosModeItem);

        mAudioVolumeTypeItem = new AudioVolumeTypeItem(this, getString(R.string.trtcdemo_volumn_type),
                getString(R.string.trtcdemo_volumn_type_auto), getString(R.string.trtcdemo_volumn_type_media),
                getString(R.string.trtcdemo_volumn_type_voip), getString(R.string.trtcdemo_no_choice));
        mSettingItemList.add(mAudioVolumeTypeItem);

        // 本地画面渲染类型
        mLocalRenderViewTypeItem = new LocalRenderViewTypeItem(this,
                getString(R.string.trtcdemo_local_render_view_type), getString(R.string.trtcdemo_render_view_default)
                , getString(R.string.trtcdemo_render_view_surfaceview),
                getString(R.string.trtcdemo_render_view_textureview), getString(R.string.trtcdemo_render_view_custom));
        mSettingItemList.add(mLocalRenderViewTypeItem);

        // 编码类型
        mEncoderTypeItem = new EncoderTypeItem(this, getString(R.string.trtcdemo_encoder_type),
                getString(R.string.trtcdemo_encoder_h265), getString(R.string.trtcdemo_encoder_h264));
        mSettingItemList.add(mEncoderTypeItem);

        // 软硬编码设置
        mEncoderItem = new EncoderItem(this, getString(R.string.trtcdemo_encoder_soft_hard_setting),
                getString(R.string.trtcdemo_encoder_software), getString(R.string.trtcdemo_encoder_hardware),
        ...
        mRadioAudioOutputItem = new AudioOutputItem(this, getString(R.string.trtcdemo_audio_output),
                getString(R.string.trtcdemo_speaker), getString(R.string.trtcdemo_receiver));
        mSettingItemList.add(mRadioAudioOutputItem);

        mAudioQualityItem = new AudioQualityItem(this, getString(R.string.trtcdemo_audio_quality),
                getString(R.string.trtcdemo_audio_quality_music), getString(R.string.trtcdemo_default),
                getString(R.string.trtcdemo_voice), getString(R.string.trtcdemo_no_choice));
        mSettingItemList.add(mAudioQualityItem);
        mRoomIdTypeItem = new RoomIdTypeItem(this, getString(R.string.trtcdemo_roomid_type),
                getString(R.string.trtcdemo_number), getString(R.string.trtcdemo_string)) {
            @Override
            public void onSelected(int index) {
                if (index == 0) {
        ...
        // 最大并发播放数
        mAudioParallelMaxCountItem = new AudioParallelMaxCountItem(this,
                getString(R.string.trtcdemo_audio_parallel_max_count));
    ...
    private void startJoinRoomInternal(final String roomId, final String userId) {
        ...
        int maxCount = TRTCConstants.TRTC_SDK_AUDIO_PARALLEL_MAX_COUNT;
        String maxCountText = mAudioParallelMaxCountItem.getText();
        if (!TextUtils.isEmpty(maxCountText)) {
            maxCount = Integer.parseInt(maxCountText);
        }
        intent.putExtra(KEY_AUDIO_PARALLEL_MAX_COUNT, maxCount);
        if (isEnableDebugMode()) {
            ...
            intent.putExtra(KEY_CUSTOM_VIDEO_PREPROCESS_PIXEL_FORMAT, ((CustomVideoPreprocessPixelFormatItem)
                    mCustomVideoPreprocessPixelFormatItem)
                    .getCustomVideoPreprocessPixelFormat());
            intent.putExtra(KEY_CUSTOM_VIDEO_PREPROCESS_BUFFER_TYPE, ((CustomVideoPreprocessBufferTypeItem)
                    mCustomVideoPreprocessBufferTypeItem)
