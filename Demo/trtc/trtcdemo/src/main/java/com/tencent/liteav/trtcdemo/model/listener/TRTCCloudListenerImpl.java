...
public class TRTCCloudListenerImpl extends TRTCCloudListener {
    ...
    public void onWarning(int warningCode, String warningMsg, Bundle extraInfo) {
        Log.i(TAG, "onWarning: " + warningCode + ", warningMsg: " + warningMsg);
    }
    ...
    public void onScreenCaptureStarted() {
        Log.i(TAG, "onScreenCaptureStarted");
    }

    @Override
    public void onScreenCapturePaused() {
        Log.i(TAG, "onScreenCapturePaused");
    }

    @Override
    public void onScreenCaptureResumed() {
        Log.i(TAG, "onScreenCaptureResumed");
    }

    @Override
    public void onScreenCaptureStopped(int reason) {
        Log.i(TAG, "onScreenCaptureStopped");
    }
