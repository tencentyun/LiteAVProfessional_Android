...
public abstract class AbsRadioButtonItem extends AbsBaseItem {
    ...
    private void initView(Context context) {
        LayoutInflater.from(context).inflate(R.layout.trtcdemo_item_setting_radio, this, true);
    ...
    private RadioButton createRadioButton(String name, int id) {
        ...
        radioButton.setTextColor(getContext().getResources().getColor(R.color.trtcvoiceroom_text_color_second));
        radioButton.setGravity(Gravity.CENTER);
        Drawable drawable = getContext().getResources().getDrawable(R.drawable.trtcdemo_bg_rb_icon_selector);
