...
public class AudioMsgItem extends AbsEditTextSendItem {

    private TRTCCloudManager mTRTCCloudManager;

    public AudioMsgItem(TRTCCloudManager manager, Context context, String title, String btnText) {
    ...
    public void send(String msg) {
        mTRTCCloudManager.bindAudioMsg(msg);
    }
}
