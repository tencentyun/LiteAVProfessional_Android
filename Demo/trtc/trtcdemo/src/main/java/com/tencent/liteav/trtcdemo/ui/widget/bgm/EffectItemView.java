...
public class EffectItemView extends ConstraintLayout implements View.OnClickListener {
    ...
    public EffectItemView(Context context, AttributeSet attrs) {
        super(context, attrs);
        inflate(context, R.layout.trtcdemo_item_setting_sound_effect, this);
        initView();
    }
    ...
    private void initView() {
        ...
        mUploadCb.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            @Override
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                if (mCallback != null) {
                    mCallback.onUploadChange(isChecked);
                }
            }
        });
    ...
    public void setCheckUpload(final boolean isChecked) {
        mUploadCb.post(new Runnable() {
            @Override
            public void run() {
                mUploadCb.setChecked(isChecked);
            }
        });
    }
    ...
    public void restoreNextStatus(int status) {
        mPlayNextStatus = status;
        updateStartBtnIcon();
    }
    ...
    public interface Callback {
        ...
        void onUploadChange(boolean upload);
    }
}
