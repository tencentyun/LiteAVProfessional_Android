...
import static com.tencent.liteav.trtcdemo.model.bean.Constant.KEY_USE_CUSTOM_RENDER_PREPROCESS;
...
public class TRTCCallActivity extends AppCompatActivity implements View.OnClickListener,
    ...
    private int     mAudioParallelMaxCount = TRTCConstants.TRTC_SDK_AUDIO_PARALLEL_MAX_COUNT;
    ...
    private void initIntentData() {
        ...
        mAudioParallelMaxCount = intent.getIntExtra(KEY_AUDIO_PARALLEL_MAX_COUNT,
                TRTCConstants.TRTC_SDK_AUDIO_PARALLEL_MAX_COUNT);
    ...
    private void enterRoom() {
        mTRTCCloudManager.setRemoteAudioParallelParams(mAudioParallelMaxCount);
    ...
    private class ExitTask extends AsyncTask {
        ContentLoadingDialog mDialog = new ContentLoadingDialog(TRTCCallActivity.this);

        @Override
        protected void onPreExecute() {
            super.onPreExecute();
            mDialog.showDialog(getString(R.string.trtcdemo_ending_call));
        }
    ...
    private TXCloudVideoView getLocalVideoView() {
        ...
        if (mIsCustomLocalRender && mCustomRender != null) {
            ...
            mTRTCCloudManager.setLocalVideoRenderListener(
                    ...
                    mCustomRender);
            mTRTCCloudManager.setCustomRenderMode(
                    intent.getBooleanExtra(KEY_CUSTOM_PROCESS_USE_RENDER_INTERFACE, false) ? 1 : 0);
