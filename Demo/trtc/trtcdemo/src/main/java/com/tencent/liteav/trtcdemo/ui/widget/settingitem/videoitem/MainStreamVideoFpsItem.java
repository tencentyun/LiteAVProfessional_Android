 ...
 * 主路帧率设置Item
 */
public class MainStreamVideoFpsItem extends AbsSelectionItem {
    private TRTCCloudManager mTRTCCloudManager;

    public MainStreamVideoFpsItem(TRTCCloudManager manager, Context context, String title, String... textList) {
    ...
    public void onSelected(int index, String str) {
        ...
        if (fps != SettingConfigHelper.getInstance().getVideoConfig().getMainStreamVideoFps()) {
            SettingConfigHelper.getInstance().getVideoConfig().setMainStreamVideoFps(fps);
