 ...
 */
public class MainStreamResolutionItem extends AbsSelectionItem {
    private OnSelectListener mListener;

    public MainStreamResolutionItem(OnSelectListener listener, Context context, String title, String... textList) {
